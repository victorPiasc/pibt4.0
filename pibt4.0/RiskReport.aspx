<%@ Page Title="" Language="C#" MasterPageFile="~/NestedBMSMasterPage.master" AutoEventWireup="true"
    CodeBehind="RiskReport.aspx.cs" Inherits="Pibt.RiskReport" %>
 ...
 <fieldset>
        ...
        <tr>
            <td style="width: 70%;">
                <telerik:RadSplitter ID="Radsplitter6" runat="server" Orientation="Vertical">
                    <telerik:RadPane ID="Radpane11" runat="server" Height="1800px" Width="700px" ContentUrl="~/UploadFiles/PIASCMar14.pdf">
                    </telerik:RadPane>
                </telerik:RadSplitter>
            ...
            <td style="width: 30%; vertical-align: top; text-align: center; font-size: 20px;
                ...
                <asp:Repeater ID="rptLifelines" runat="server" OnItemCommand="rptLifelines_ItemCommand">
                    <ItemTemplate>
    ...
    <script type="text/javascript">
       function openPdf(sender, args) {
          window.radopen("UploadFiles/PIASCMar14.pdf", "RadWindow1");
       }
    </script>

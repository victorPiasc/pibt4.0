<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtlBrokerCommission.ascx.cs" Inherits="Pibt.UserControl.CtlBrokerCommission" %>
...
<div class="row">
    <div class="col-md-12">
        <fieldset>
            <telerik:RadGrid ID="commHist" runat="server" Skin="MetroTouch" AutoGenerateColumns="false" EnableLinqExpressions="false" AllowMultiRowSelection="false" AllowPaging="true" OnNeedDataSource="commHist_NeedDataSource" >
                ...
                <MasterTableView DataKeyNames="employerId" ClientDataKeyNames="employerId">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Commission" UniqueName="commission" HeaderText="Commission Earned" SortExpression="commission" DataFormatString="{0:C}" DataType="System.Decimal" >
                            <ItemStyle HorizontalAlign="Right" />
                        </telerik:GridBoundColumn>

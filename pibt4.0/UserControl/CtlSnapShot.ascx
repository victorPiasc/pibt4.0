...
<div class="row">
    <div class="col-md-12">
        <fieldset>
            <telerik:RadGrid ID="snapshot" runat="server" Skin="MetroTouch" AutoGenerateColumns="false" OnNeedDataSource="snapshot_NeedDataSource" EnableLinqExpressions="false" AllowMultiRowSelection="false" AllowPaging="true">
                ...
                <MasterTableView DataKeyNames="employerId" ClientDataKeyNames="employerId">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="outstanding" UniqueName="outstanding" headertext="Prior Outstanding" SortExpression="outstanding" DataFormatString="{0:C}" DataType="System.Decimal" >
                        ...
                        <telerik:GridCalculatedColumn DataFields="outstanding, invoiced, paid" UniqueName="currOut" HeaderText="Current Outstanding" Expression="{0}+{1}-{2}" DataFormatString="{0:C}" DataType="System.Decimal" >
                            <ItemStyle HorizontalAlign="Right" />
                        ...
                        <telerik:GridBoundColumn DataField="commission" UniqueName="commission" HeaderText="Commissions Earned" SortExpression="commission" DataFormatString="{0:C}" DataType="System.Decimal" >
                            <ItemStyle HorizontalAlign="Right" />
                        </telerik:GridBoundColumn>

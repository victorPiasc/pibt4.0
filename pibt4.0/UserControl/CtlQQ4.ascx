...
<div id="popup1" class="popup2" style="width: 65%; padding: 20px; left: 15%;" runat="server">
    <div style="background: #FFFFFF; padding: 10px;">
        <asp:Panel ID="panel1" runat="server" DefaultButton="hidden">
        ...
        <div class="row">
            <div class="column-4 col-md-4">
                <asp:Button ID="addDep" runat="server" Text="Save" CssClass="btn" OnClick="dep_Click" CommandName="add" ValidationGroup="update" CausesValidation="true" />
            </div>
            <div class="column-4 col-md-4">
...
<div class="row">
    ...
    <div class="column-12 col-md-12">
        <fieldset style="padding: 0px 10px 10px 10px !important; border: 1px solid #CFCFCE;">
            ...
            <asp:Button ID="btnUpload" runat="server" CssClass="btn" Text="Upload Census File" OnClientClick=" genPopUp('popup4', true);return false;" />
                                ...
                                <div style="padding: 15px;">
                                    <div class="row">
                                        <div class="column-3 col-md-3">
                                            ...
                                            <asp:RequiredFieldValidator ID="fNameValid" runat="server" ErrorMessage="*" ForeColor="Red" Font-Bold="true" Font-Size="X-Large" ControlToValidate="fName" Display="Static" ValidationGroup="updateMember"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="column-3 col-md-3">
                                            Last Name:
                                            ...
                                            <asp:RequiredFieldValidator ID="lNameValid" runat="server" ErrorMessage="*" ForeColor="Red" Font-Bold="true" Font-Size="X-Large" ControlToValidate="lName" Display="Static" ValidationGroup="updateMember"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="column-3 col-md-3">
                                            Gender:
                                            ...
                                            <asp:RequiredFieldValidator ID="genderValid" runat="server" ErrorMessage="*" ForeColor="Red" Font-Bold="true" Font-Size="X-Large" ControlToValidate="gender" InitialValue="0" Display="Static" ValidationGroup="updateMember"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="column-3 col-md-3">
                                            Birthdate:
                                            ...
                                            <asp:RequiredFieldValidator ID="bDayValid" runat="server" ErrorMessage="*" ForeColor="Red" Font-Bold="true" Font-Size="X-Large" ControlToValidate="bDay" Display="Static" ValidationGroup="updateMember"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="column-3 col-md-3">
                                            SSN:
                                            ...
                                            <asp:RequiredFieldValidator ID="ssnValid" runat="server" ErrorMessage="*" ForeColor="Red" Font-Bold="true" Font-Size="X-Large" ControlToValidate="ssn" Display="Dynamic" ValidationGroup="updateMember"></asp:RequiredFieldValidator>
                                            <asp:RegularExpressionValidator ID="ssnReg" runat="server" ErrorMessage="*" ForeColor="Red" Font-Bold="true" Font-Size="X-Large" ControlToValidate="ssn" ValidationExpression="\d+" Display="Dynamic" ValidationGroup="updateMember"></asp:RegularExpressionValidator>
                                        </div>
                                        <asp:Panel ID="noChild" runat="server" Visible='<%# Eval("employeeType").ToString() != "2" ? true : false %>'>
                                            <div class="column-3 col-md-3">
                                                ...
                                                <asp:RequiredFieldValidator ID="smokerValid" runat="server" ErrorMessage="*" ForeColor="Red" Font-Bold="true" Font-Size="X-Large" ControlToValidate="smokerChoice" Display="Static" ValidationGroup="updateMember"></asp:RequiredFieldValidator>
                                            </div>
                                        </asp:Panel>
                                        <div class="column-3 col-md-3">
                                            Email
                                            ...
                                            <asp:RequiredFieldValidator ID="emailValid" runat="server" ErrorMessage="*" ForeColor="Red" Font-Bold="true" Font-Size="X-Large" ControlToValidate="email" Display="Dynamic" ValidationGroup="updateMember" Visible='<%# Eval("employeeType").ToString()=="0" %>'></asp:RequiredFieldValidator>
                                            <asp:RegularExpressionValidator ID="cEmailReg" ValidationExpression="^[\w\.\-]+@[a-zA-Z0-9\-]+(\.[a-zA-Z0-9\-]{1,})*(\.[a-zA-Z]{2,3}){1,2}$" ControlToValidate="email" runat="server" ErrorMessage="*" ForeColor="Red" Font-Bold="true" Font-Size="X-Large" ValidationGroup="updateMember"></asp:RegularExpressionValidator>
                                        </div>
                                        <asp:Panel ID="noDep" runat="server" Visible='<%# Eval("employeeType").ToString()=="0" %>'>
                                            <div class="column-3 col-md-3">
                                                ...
                                                <asp:RequiredFieldValidator ID="hoursValid" runat="server" ErrorMessage="*" ForeColor="Red" Font-Bold="true" Font-Size="X-Large" ControlToValidate="hours" Display="Dynamic" ValidationGroup="updateMember"></asp:RequiredFieldValidator>
                                                <asp:RegularExpressionValidator ID="hoursReg" runat="server" ErrorMessage="*" ForeColor="Red" Font-Bold="true" Font-Size="X-Large" ControlToValidate="hours" ValidationExpression="\d+" Display="Dynamic" ValidationGroup="updateMember"></asp:RegularExpressionValidator>
                                            </div>
                                        </asp:Panel>
                                    </div>
                                    <div class="row">

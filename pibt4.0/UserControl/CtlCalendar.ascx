                ...
                <div class="col-md-6">
                    <table style="width:100%">
                        <tr>
                            ...
                            <td><asp:TextBox ID="tbSearch" runat="server" CssClass="form-control" MaxLength="60" style="width:60%;"></asp:TextBox></td>
                        </tr>
                    </table>
                </div>
                <div class="col-md-6">
            ...
            <telerik:RadGrid ID="events" runat="server" Skin="MetroTouch" AutoGenerateColumns="false" OnNeedDataSource="events_NeedDataSource" EnableLinqExpressions="false" >
                ...
                <MasterTableView DataKeyNames="id" ClientDataKeyNames="id">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="renewalDate" UniqueName="renewalDate" HeaderText="Upcoming Date" SortExpression="renewalDate" DataType="System.DateTime" DataFormatString="{0:d}"></telerik:GridBoundColumn>

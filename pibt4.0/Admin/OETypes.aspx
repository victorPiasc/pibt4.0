...
<asp:Content ID="Content6" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <telerik:RadGrid ID="RadGridOETypes" runat="server" AllowPaging="True" Height="100%" Skin="MetroTouch" AutoGenerateColumns="False" GridLines="None"
        AllowSorting="True" CellSpacing="0" AllowAutomaticInserts="False" AllowAutomaticDeletes="True" AllowAutomaticUpdates="True"
                        ...
                        <tr class="row">
                            ...
                            <td class="item-value">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ContentEditor" CssClass="required-info"
                                    ErrorMessage="Usage is required" Display="Dynamic" ValidationGroup="CustomerInfo"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>

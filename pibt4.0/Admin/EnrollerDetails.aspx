<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnrollerDetails.aspx.cs" Inherits="Pibt.Admin.EnrollerDetails" MasterPageFile="~/Content.master"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <telerik:RadMultiPage runat="server" SelectedIndex="0" ID="RadMultiPage1" CssClass="multiPage">
        <telerik:RadPageView runat="server" ID="RadPageView1" CssClass="productsPageView">
            <uc1:CtlEditAgentDetails ID="CtlEditAgentDetails1" Role="Enroller" runat="server" />
        </telerik:RadPageView>
        <telerik:RadPageView runat="server" ID="RadPageView2">
            <uc3:CtlCreateWebUser ID="CtlCreateWebUser1" Role="Enroller" runat="server" />
            <uc4:CtlChangePassword ID="CtlChangePassword1" Role="Enroller" runat="server" />
        </telerik:RadPageView>

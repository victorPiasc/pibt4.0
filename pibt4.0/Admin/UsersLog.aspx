...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <telerik:RadGrid ID="LogGrid" runat="server" AllowPaging="True" Height="100%" AllowSorting="true" Skin="MetroTouch" AutoGenerateColumns="False"
        GridLines="None" CellSpacing="0" OnNeedDataSource="LogGrid_NeedDataSource">

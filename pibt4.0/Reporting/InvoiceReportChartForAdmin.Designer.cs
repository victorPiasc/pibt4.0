...
{
    partial class InvoiceReportChartForAdmin
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.odsAgency = new Telerik.Reporting.ObjectDataSource();
            ...
            this.graph2.DataSource = this.odsInvoiceChart;
            ...
            // odsInvoiceChart
            // 
            this.odsInvoiceChart.DataMember = "GetInvoiceChartForAdmin";
            ...
            new Telerik.Reporting.ObjectDataSourceParameter("agencyId", typeof(string), "=Parameters.AgencyId.Value"),
            new Telerik.Reporting.ObjectDataSourceParameter("isCobrMember", typeof(string), "=Parameters.CobraMember.Value"),
            ...
            // odsAgency
            // 
            this.odsAgency.DataMember = "GetEnterpriseWithDefault";
            this.odsAgency.DataSource = typeof(Pibt.BLL.Employer);
            this.odsAgency.Name = "odsAgency";
            // 
            // odsPlanTypes
            // 
            ...
            reportParameter1.AvailableValues.DataSource = this.odsAgency;
            reportParameter1.AvailableValues.DisplayMember = "Description";
            reportParameter1.AvailableValues.Sortings.Add(new Telerik.Reporting.Sorting("AgencyId", Telerik.Reporting.SortDirection.Asc));
            reportParameter1.AvailableValues.ValueMember = "AgencyId";
            reportParameter1.Name = "AgencyId";
            reportParameter1.Value = "0";
            reportParameter1.Visible = true;
            reportParameter2.AutoRefresh = true;
            reportParameter2.Name = "CobraMember";
            ...
            reportParameter3.AvailableValues.DataSource = this.odsPlanTypes;
            reportParameter3.AvailableValues.DisplayMember = "Description";
            reportParameter3.AvailableValues.Sortings.Add(new Telerik.Reporting.Sorting("SORTSEQ", Telerik.Reporting.SortDirection.Asc));
            reportParameter3.AvailableValues.ValueMember = "Plantypeid";
            reportParameter3.Name = "PlanTypeId";
            reportParameter3.Text = "PlanType";
            ...
            reportParameter4.AvailableValues.DisplayMember = "months";
            reportParameter4.AvailableValues.ValueMember = "months";
            reportParameter4.Name = "Months";
            reportParameter4.Text = "In months";
            reportParameter4.Value = "6";
        ...
        private Telerik.Reporting.ObjectDataSource odsAgency;

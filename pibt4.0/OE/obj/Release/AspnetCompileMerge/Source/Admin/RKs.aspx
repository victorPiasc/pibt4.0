...
<%@ Register Src="../UserControl/CtlAddWebUser.ascx" TagName="CtlAddWebUser" TagPrefix="uc2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <uc2:CtlAddWebUser ID="CtlAddWebUser1" runat="server" Role="RK" />
    <fieldset>
    ...
    <br />
    <asp:Button ID="btnSynRK" runat="server" CssClass="btn" Text="Click here to Sync All RKs" OnClick="btnSynRK_Click" /><br />
    ...
    <telerik:RadGrid ID="RadGridRKs" runat="server" AllowPaging="True" Height="100%"
        ...
        <MasterTableView AutoGenerateColumns="False" EditMode="InPlace" DataKeyNames="Id,UserId,Loginname,CSRID"
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="CSRID" SortExpression="CSRID" UniqueName="CSRID"
                    HeaderText="RK ID#" DataType="System.Int32">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="LoginName" SortExpression="LoginName" UniqueName="LoginName"
                    HeaderText="Web Login ID#" DataType="System.String">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="UserId" SortExpression="UserId" UniqueName="UserId"
                    HeaderText="User ID#" DataType="System.String">
                </telerik:GridBoundColumn>
                ...
                <telerik:GridHyperLinkColumn ItemStyle-HorizontalAlign="Left" UniqueName="" HeaderStyle-Font-Bold="false"
                    HeaderStyle-Wrap="false" DataNavigateUrlFields="UserId" DataNavigateUrlFormatString="/Admin/RKDetails.aspx?uid={0}"
                    HeaderStyle-Width="20px" Text="Edit">
                    <ItemStyle Wrap="True" Font-Underline="true" />
                </telerik:GridHyperLinkColumn>
                <telerik:GridHyperLinkColumn ItemStyle-HorizontalAlign="Left" UniqueName="" HeaderStyle-Font-Bold="false"
                    HeaderStyle-Wrap="false" DataNavigateUrlFields="UserId" DataNavigateUrlFormatString="/Employer/BusinessList.aspx?uid={0}&roletype=3"
                    HeaderStyle-Width="20px" Text="Employers">
                    <ItemStyle Wrap="True" Font-Underline="true" />
                </telerik:GridHyperLinkColumn>

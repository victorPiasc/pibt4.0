    ...
    <telerik:RadGrid ID="RadGridEvents" runat="server" AllowPaging="True" Height="100%" 
        ...
        <MasterTableView AutoGenerateColumns="False" DataKeyNames="EVENTID" AllowSorting="true"
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="EVENTID" SortExpression="EVENTID" UniqueName="EVENTID"
                    HeaderText="ID#">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="EVENTNAME" SortExpression="EVENTNAME" UniqueName="EVENTNAME"
                    HeaderText="NAME">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataFormatString="{0:MM/dd/yyyy}" DataField="EVENTDATE"
                    SortExpression="EVENTDATE" UniqueName="EVENTDATE" HeaderText="EVENT DATE">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataFormatString="{0:c2}" DataField="COST" SortExpression="COST"
                    UniqueName="COST" HeaderText="COST">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="LOCATION" SortExpression="LOCATION" UniqueName="LOCATION"
                    HeaderText="LOCATION">
                </telerik:GridBoundColumn>
                ...
                <telerik:GridHyperLinkColumn ItemStyle-HorizontalAlign="Left" UniqueName="" HeaderStyle-Font-Bold="false"
                    HeaderStyle-Wrap="false" DataNavigateUrlFields="EVENTID" DataNavigateUrlFormatString="/EventDetails.aspx?id={0}"

...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <uc2:CtlAddWebUser ID="CtlAddWebUser1" runat="server" Role="Agent" />
    <fieldset>
    ...
    <br />
    <asp:Button ID="btnSynAgent" runat="server" Text="Click here to Sync All Agents"  CssClass="btn"
        OnClick="btnSynAgent_Click" /><br />
        ...
        <MasterTableView AutoGenerateColumns="False" EditMode="InPlace" DataKeyNames="Id,UserId,Loginname,ENROLLERID"
            ...
            <Columns>
                ...
                <telerik:GridHyperLinkColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Font-Bold="false"
                    HeaderStyle-Wrap="false" DataNavigateUrlFields="UserId" DataNavigateUrlFormatString="/Admin/AgentDetails.aspx?uid={0}"
                    HeaderStyle-Width="20px" Text="Edit">
                    <ItemStyle Wrap="True" Font-Underline="true" />
                </telerik:GridHyperLinkColumn>
                <telerik:GridHyperLinkColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Font-Bold="false"
                    HeaderStyle-Wrap="false" DataNavigateUrlFields="UserId" DataNavigateUrlFormatString="/Employer/BusinessList.aspx?uid={0}&roletype=2"

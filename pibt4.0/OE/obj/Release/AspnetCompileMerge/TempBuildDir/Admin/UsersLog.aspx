...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <telerik:RadGrid ID="LogGrid" runat="server" AllowPaging="True" Height="100%" AllowSorting="true"
        ...
        <MasterTableView AutoGenerateColumns="False" EditMode="InPlace" DataKeyNames="LogId" CommandItemDisplay="Top"
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="LogId" SortExpression="LogId" UniqueName="LogId"
                    HeaderText="Log ID#" DataType="System.Int32">
                ...
                <telerik:GridBoundColumn DataField="EventTime" HeaderText="Event Time" SortExpression="EventTime"
            ...
            <CommandItemTemplate>
                <asp:Button ID="btnRemoveRecrods" CssClass="btn" Text="Click To Remove History" CommandName="Remove" OnClick="btnRemoveRecrods_Click" runat="server" />
                <asp:DropDownList ID="ddlMonths" runat="server">
                    <asp:ListItem Text="3 months ago" Value="3"></asp:ListItem>
                    <asp:ListItem Text="6 months ago" Value="3"></asp:ListItem>
                    <asp:ListItem Text="12 months ago" Value="3"></asp:ListItem>
                </asp:DropDownList>
            </CommandItemTemplate>
        </MasterTableView>

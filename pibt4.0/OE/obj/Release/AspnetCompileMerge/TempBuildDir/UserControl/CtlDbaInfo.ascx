...
<div class="customer-info-box">
    ...
    <div class="section-body">
        <telerik:RadGrid ID="RadGridDBA" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            OnInsertCommand="RadGridDBA_InsertCommand" OnItemInserted="RadGridDBA_ItemInserted"
            OnItemUpdated="RadGridDBA_ItemUpdated" OnUpdateCommand="RadGridDBA_UpdateCommand"
            OnDataBound="RadGridDBA_DataBound" OnPreRender="RadGridDBA_PreRender">
            <PagerStyle Mode="NextPrevAndNumeric" />
            <GroupingSettings CaseSensitive="false" />
            <MasterTableView AutoGenerateColumns="False" DataKeyNames="rowId" AllowSorting="true"
                PageSize="16" CommandItemDisplay="Top" CommandItemSettings-ShowRefreshButton="true"
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn ItemStyle-Width="100%" DataField="Dbaname" SortExpression="Dbaname"
                        UniqueName="Dbaname" HeaderText="DBA NAME">

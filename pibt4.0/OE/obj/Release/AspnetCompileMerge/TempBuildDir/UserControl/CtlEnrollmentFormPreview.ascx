...
<center>
    <p>
        <h1>
            <asp:Literal ID="HeadTypeName" runat="server"></asp:Literal></h1>
    </p>
    <div class="EnrollmentFormView">
        <div class="header">
            <img class="logo" src="/img/PIBT_2015-2016.jpg" width="200px" alt="PIBT" />
            <div class="contactInfo" style="margin-top:-5px;">
                ...
                <div>
                       Fax: (323) 215-1796 <a href="http://www.pibt.org/">www.pibt.org</a> License #0747420</div>
            </div>
        </div>
            ...
            <div class="section-body">
                <asp:GridView ID="gvTerminatePlans" Width="750" AutoGenerateColumns="False" AllowSorting="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="expirydate" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-HorizontalAlign="Center"
            ...
            <div class="section-body">
                <asp:GridView ID="gvPCP" Width="750px" AutoGenerateColumns="False" AllowSorting="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="PlanOffice3" HeaderText="MEDICAL GROUP NAME" SortExpression="PlanOffice3" />
                        <asp:BoundField DataField="PlanOffice4" HeaderText="IPA/MEDICAL GROUP NAME" SortExpression="PlanOffice4" />
                    </Columns>
                    <EmptyDataTemplate>
                        Not Available
                    </EmptyDataTemplate>
            ...
            <div class="section-body">
                <asp:GridView ID="gvDental" Width="750px" AutoGenerateColumns="False" AllowSorting="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="PlanOffice3" HeaderText="ALTERNATE DENTAL OFFICE NAME"
                            SortExpression="PlanOffice3" />
                        <asp:BoundField DataField="PlanOffice4" HeaderText="OFFICE #" SortExpression="PlanOffice4" />
                    </Columns>
                    <EmptyDataTemplate>
                        Not Available
                    </EmptyDataTemplate>
            ...
            <div class="section-body">
                <asp:GridView ID="gvConverageAddtional" Width="750px" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:BoundField DataField="Name" HeaderText="NAME" SortExpression="Name" />
                        <asp:BoundField DataField="Planname" HeaderText="PLAN NAME" SortExpression="Planname" />
                        <asp:BoundField DataField="RATETYPEDESC" HeaderText="RATETYPEDESC" SortExpression="RATETYPEDESC" />
                        <asp:BoundField DataField="SALARY" HeaderText="SALARY" SortExpression="SALARY" DataFormatString="{0:C}" />
                        <asp:BoundField DataField="INSURANCEAMOUNT" HeaderText="INSURANCEAMOUNT" SortExpression="INSURANCEAMOUNT"

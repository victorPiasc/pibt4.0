<%@ Page Title="" Language="C#" MasterPageFile="~/WebsiteWithFooter.master" AutoEventWireup="true"
                  ...
                  <telerik:RadPageView runat="server" ID="RadPageView1">
                     <div class="customer-info-box" style="margin-top: 15px;">
                        <table class="table-container">
                           <tr>
                              <td class="cell-top">
                                 <%--<fieldset style="width: 920px; min-height: 70px;">
                        <legend style="font-family: Open sans;">Search Documents</legend>
                        <div class="ui-widget">
                           <input id="tags" type="search" class="form-control">
                        </div>
                     </fieldset> tooltip="Click  to start" --%>
                                 ...
                                 <telerik:RadTreeView ID="GeneralTreeView" runat="server" OnClientDoubleClick="DoubleClick" OnNodeExpand="TreeView1_NodeExpand" ToolTip='Double-click to expand/collapse'>
                                 </telerik:RadTreeView>
                              </td>
                           </tr>
                        </table>

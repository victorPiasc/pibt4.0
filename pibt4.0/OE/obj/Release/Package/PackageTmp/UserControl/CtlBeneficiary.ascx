    ...
    <telerik:RadGrid ID="RadGrid1" CssClass="AutoWidthGrid" runat="server" Skin="MetroTouch"
        ...
        <MasterTableView DataSourceID="odsBeneficiary" CommandItemDisplay="Top" DataKeyNames="ID">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="plantypeName" HeaderText="COVERAGE TYPE" SortExpression="plantypeName"
                    UniqueName="plantypeName">
                       ...
                       <tr>
                          ...
                          <td>
                             ...
                             <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="ddlRelationship"
                                                CssClass="required-info" Display="Dynamic" ErrorMessage="* Required Field"></asp:RequiredFieldValidator>
                          </td>
                       </tr>
                       <tr>
                          <td>
                             Middle Init:
                              ...
                              <asp:TextBox ID="tbMiddle" runat="server" MaxLength="1" Width="8" TabIndex="3" Text='<%# Bind( "MIDDLEINITIAL") %>'>
                                            </asp:TextBox>
                          </td>

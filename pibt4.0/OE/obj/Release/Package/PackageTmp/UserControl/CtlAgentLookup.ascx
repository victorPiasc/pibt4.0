            ...
            <div>
                <telerik:RadGrid ID="CurrentEmployeesByEnrollerGrid" runat="server" DataKeyNames="enrollerId"
                    ...
                    <MasterTableView AllowMultiColumnSorting="true" EditMode="InPlace" PageSize="20"
                        ...
                        <Columns>
                            <telerik:GridBoundColumn DataField="EMPLOYERID" UniqueName="EMPLOYERID" HeaderText="EMPLOYERID"
...
<%--<asp:ObjectDataSource ID="odsAgentList" runat="server" SelectMethod="GetAgentList"
...
<%--<asp:ObjectDataSource ID="odsAgentId" runat="server" SelectMethod="GetAgentIdByAgentName"
    TypeName="Pibt.BLL.Agent">
    <SelectParameters>
        <asp:ControlParameter ControlID="AgentComboBox" Name="EnrollerId" PropertyName="SelectedValue"
            Type="String" />
    </SelectParameters>
</asp:ObjectDataSource>
--%>
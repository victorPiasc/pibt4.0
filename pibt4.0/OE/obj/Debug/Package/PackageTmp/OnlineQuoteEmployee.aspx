        ...
        <div class="row">
            <div class="column-12">                
                <fieldset>
                    ...
                    <hr />
                    <div style ="font-size:14px; font-weight:bold; margin-bottom:10px;">To add employee details, simply enter the required information below (Employee’s name, Type, Gender and Birth Date) and then click on the “Add to Quote” box.  Once you have completed entering the employee information and clicking the “Add to Quote” box, you can now enter any additional family members by opening the “Type” box and selecting either “spouse” or “child”.  Finish by clicking on the “Add to Quote” box before entering any additional family members. </div>
                                        ...
                                        <tbody>
                                            <tr class="row">
                                                ...
                                                <td>
                                                    ...
                                                    <%--<asp:Label ID="CountOver" runat="server" EnableViewState="False"  CssClass="required-info"></asp:Label>--%>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">&nbsp;</td>
                                            ...
                                            <tr class="row">
                                                ...
                                                <td>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" CssClass="required-info" SetFocusOnError="true"
                                                        ErrorMessage="*Birth date is a required field" ControlToValidate="dpBirthDate" ValidationGroup="inputGroup"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                           <%-- <tr>
                                                <td colspan="3">&nbsp;</td>
                                            ...
                                            <tr class="row">
                                                ...
                                                <td>
                                                    <asp:RequiredFieldValidator ID="ZipCodeValidator" runat="server" CssClass="required-info" SetFocusOnError="true"
                                                        ErrorMessage="*Zip code is a required field" ControlToValidate="tbPostCode" ValidationGroup="inputGroup"></asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ValidationExpression="[0-9]{5,}" ControlToValidate="tbPostCode"
                                                        runat="server" ErrorMessage="*Please enter valid zip code" CssClass="required-info" ValidationGroup="inputGroup"></asp:RegularExpressionValidator></td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">&nbsp;</td>
                                            </tr>
                                            <tr class="row">
                                                ...
                                                <td>
                                                    <asp:RequiredFieldValidator ID="ddlSmokerValidator" runat="server" ErrorMessage="*Please select Smoker" CssClass="required-info" ControlToValidate="ddlSmoker" ValidationGroup="inputGroup" InitialValue="4"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>--%>
                                        </tbody>
                                    </table>
                                ...
                                <div class="section-body">
                                    <telerik:RadGrid ID="employeeRadGrid" DataKeyNames="ROWID" AllowMultiRowSelection="false" runat="server" AutoGenerateColumns="false" AllowSorting="true" AllowPaging="false" Skin="MetroTouch"  CssClass="ChoosePlanGird" GridLines="None" ShowStatusBar="true" OnNeedDataSource="employeeGrid_NeedDataSource" OnDeleteCommand="employeeRadGrid_DeleteCommand"
                                        ...
                                        <MasterTableView CommandItemSettings-ShowAddNewRecordButton="false" DataKeyNames="ROWID">
                                            ...
                                            <Columns>
                                                <telerik:GridBoundColumn SortExpression="ROWID" UniqueName="ROWID" HeaderText="ROWID" DataField="ROWID" Visible="false"></telerik:GridBoundColumn>
                                                ...
                                                <telerik:GridBoundColumn SortExpression="EMPLOYEENAME" UniqueName="EMPLOYEENAME" HeaderText="EMPLOYEE NAME" DataField="EMPLOYEENAME"></telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn SortExpression="EMPLOYEETYPE" UniqueName="EMPLOYEETYPE" HeaderText="EMPLOYEE TYPE" DataField="EMPLOYEETYPE"></telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn SortExpression="BIRTHDATE" UniqueName="BIRTHDATE" HeaderText="BIRTHDATE" DataField="BIRTHDATE" DataFormatString="{0:MM/dd/yyyy}" ></telerik:GridBoundColumn>
                                               <%-- <telerik:GridBoundColumn SortExpression="ZIP" UniqueName="ZIP" HeaderText="ZIP" DataField="ZIP"></telerik:GridBoundColumn>--%>

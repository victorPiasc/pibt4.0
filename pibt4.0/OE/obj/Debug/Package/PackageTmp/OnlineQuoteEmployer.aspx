            ...
            <div class="column-12">
                <fieldset>
                    ...
                    <%-- <div style="font-size:14px; color:red; font-weight:bold">
                            If adding more than 10 employees <asp:LinkButton ID="Link" runat="server" Text="Click Here" PostBackUrl="/OnlineQuoteTenPlus.aspx"></asp:LinkButton>
                        </div>--%>
                    <div style="font-size:14px; color:red; font-weight:bold">
                                    ...
                                    <table class="table-container">
                                        <tbody>
                                            ...
                                            <%--<tr class="row">
                                                ...
                                                <td class="item-value" colspan="2">
                                                    <asp:CheckBox ID="publicComputer" runat="server" />
                                                </td>
                                            </tr>--%>
                                        </tbody>
                                    </table>                             

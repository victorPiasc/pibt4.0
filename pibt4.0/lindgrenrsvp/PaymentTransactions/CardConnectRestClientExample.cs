...
namespace CardConnectRestClientExample
{
    ...
    {
        private static String ENDPOINT = "https://fts.cardconnect.com:6443";
        ...
        */
        public static String authTransaction() {
            ...
            // Merchant ID
            request.Add("merchid", "496160873888");  //  496226287886   496160873888  496400000840
            // Card Type
            request.Add("accttype", "VI");
            // Card Number
            request.Add("account", "4111111111111111");
            // Card Expiry
            request.Add("expiry", "0918");
            // Card CCV2
        ...
        */
        public static String authTransactionWithUserFields() {
            ...
            request.Add("accttype", "VI");
            // Card Number
            request.Add("account", "411111111111111");
            // Card Expiry
            request.Add("expiry", "0918");
            // Card CCV2
            request.Add("cvv2", "776");

...
<asp:Content ID="Content6" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
   ...
   <telerik:RadGrid ID="PlansGrid" runat="server" AllowPaging="True" Height="100%" AutoGenerateColumns="False" OnItemDataBound="binder" GridLines="None"
       AllowSorting="True" CellSpacing="0" DataSourceID="odsSearchPlans" Skin="MetroTouch">
      ...
      <MasterTableView AutoGenerateColumns="False" EditMode="InPlace" DataKeyNames="MEMBERPLANID"
         ...
         <Columns>
            <telerik:GridHyperLinkColumn ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Underline="true" DataNavigateUrlFields="employeeId,employerId"
                DataNavigateUrlFormatString="EmployeeDetails.aspx?eeId={0}&erId={1}" ItemStyle-VerticalAlign="Bottom" DataTextField="EMPLOYEEID"
                SortExpression="EMPLOYEEID #ID" UniqueName="EMPLOYEEID" HeaderText="View Employee ID" DataTextFormatString="{0}">

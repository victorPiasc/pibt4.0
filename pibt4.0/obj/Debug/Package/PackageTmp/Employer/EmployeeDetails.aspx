...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <div class="customer-info-box">
        <table class="table-container">
            <tr>
                <asp:PlaceHolder ID="whoBox" runat="server">
                    <td class="cell-top">
                            ...
                            <asp:FormView ID="FormView_MemberDetials" Width="735" runat="server" EmptyDataText="No record found">
                                <ItemTemplate>
                                    <div class="bottom-left-buttons" style="margin-bottom: -15px;">
                                        ...
                                        <asp:Button ID="lnkOE" runat="server" CssClass="btn" OnCommand="button_Command" Text="Plan Enrollment" CommandName="OE" Visible='<%# !(CurrentUserInfo.UserRole == Pibt.Model.UserRoles.Dependent || CurrentUserInfo.UserRole == Pibt.Model.UserRoles.Employee) %>' />
                                        <asp:Button ID="lnk_Term" runat="server" CssClass="btn" OnCommand="button_Command" Text="Employee Termination" CommandName="term" Visible='<%#!(CurrentUserInfo.UserRole == Pibt.Model.UserRoles.Employee || CurrentUserInfo.UserRole == Pibt.Model.UserRoles.Dependent)%>' />
                                    </div>
                                                ...
                                                <table class="table-container">
                                                    <tbody>
                                                        ...
                                                        <asp:PlaceHolder runat="server" ID="phMarriageDate">
                                                            <tr class="row" <%#Eval("marriageDateHider")%>>
                                                        ...
                                                        <asp:PlaceHolder runat="server" ID="phHireDateDate">
                                                            <tr class="row" <%#Eval("hireDateHider")%>>
                                                                <td class="item-name">Hire Date:
                                                                </td>
                                                                <td class="item-value">
                                                        ...
                                                        <asp:PlaceHolder runat="server" ID="phSmoker">
                                                            <tr class="row">
                                                                <td class="item-name">Smoker:
                                                                </td>
                                                                <td class="item-value">
                                                                    <%# Eval("smoker")=="Y" ? "Yes":"No" %>&nbsp;
                                                                </td>
                                                            </tr>
                                                        </asp:PlaceHolder>
                                                        <asp:PlaceHolder runat="server" ID="phHours">
                                                            <tr class="row" <%#Eval("hoursHider") %>>
                                                                <td class="item-name">Hours Worked:
                                                                </td>
                                                                <td class="item-value">
                                                                    <%# Eval("hoursworked") %>
                                                                </td>
                                                ...
                                                <table class="table-container">
                                                    <tbody>
                                                        <asp:PlaceHolder runat="server" ID="phPhsicalStreetAddress1">
                                                            <tr class="row">
                                                                <td class="item-name">Street&nbsp;Address:
                                                                </td>
                                                                <td class="item-value">
                                                                    <%# Eval("address")%>&nbsp;
                                                                </td>
                                                ...
                                                <table class="table-container">
                                                    <tbody>
                                                        ...
                                                        <asp:PlaceHolder runat="server" ID="phDepartment">
                                                            <tr class="row" <%#Eval("departmentHider")%>>
                                                                <td class="item-name">Office Department:&nbsp;&nbsp;
                                                                </td>
                                                                <td class="item-value">
                                                                    <%# Eval("deptCode")%>:&nbsp;<%# Eval("deptname")%>&nbsp;
                                                                </td>
                                                            </tr>
                                                        </asp:PlaceHolder>
                                                    </tbody>
                                                ...
                                                <table class="table-container">
                                                    <tbody>
                                                        ...
                                                        <asp:PlaceHolder ID="trAdoptionDate" runat="server">
                                                            <tr class="row" <%#Eval("adoptionDateHider")%>>
                                                                <td class="item-name">Adoption Date:
                                                                </td>
                                                                <td class="item-value">
                    ...
                    <fieldset>
                        ...
                        <div class="details">
                            ...
                            <div class="data-container">
                                <table class="table-container">
                                    <tr class="row">
                                        <td class="item-name">Benefit Type:
                                        </td>
                                        <td class="item-value">
                                            <%#Eval("description")%>&nbsp;
                                        </td>
                                    ...
                                    <tr class="row" <%#Eval("dateHider")%>>
                                        <td class="item-name">Temination Date:
                                        </td>
                                    ...
                                    <tr class="row" <%#Eval("dateHider")%>>
                                        <td class="item-name">Temination Reason:&nbsp;&nbsp;
                                        </td>
                                        <td class="item-value red">
                                            <%#Eval("reason")%>&nbsp;
                                        </td>
                                    </tr>
                                    <tr class="row" <%#Eval("buttonHider")%>>
                                        <td class="item-name"></td>
                                        <td class="item-value">
                                            <asp:Button ID="h1_Term" runat="server" CssClass="btn" OnCommand="button_Command"
                                                Text="Drop this Coverage" CommandArgument='<%# Eval("memberid") +";"+ Eval("planId")+";"%>'
                                                Visible='<%#CurrentUserInfo.UserRole!=Pibt.Model.UserRoles.Dependent%>' />
                                        </td>
                                    </tr>
                                </table>
                            </div>

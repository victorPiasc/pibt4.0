...
<fieldset>
    ...
    <asp:Label ID="Label2" runat="server" Text="Label2" Font-Size="14px" Font-Bold="true">
                        ...
                        <tr class="row">
                            ...
                            <td class="item-value">
                                <asp:DropDownList ID="ddlEeType" runat="server" CssClass="form-control" AutoPostBack="true" Width="260px"
                                    ...
                                    <asp:ListItem Selected="true" Text="-- Select --" Value="4"></asp:ListItem>
                                ...
                                <asp:RequiredFieldValidator ID="requireDdlEeType" runat="server" CssClass="required-info" ControlToValidate="ddlEeType" Text="*"
                                    ErrorMessage="Select a relationship type" InitialValue="4" Display="Dynamic" ></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr class="row">

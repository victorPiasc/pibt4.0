                  ...
                  <Items>
                      ...
                      <telerik:RadPanelItem Text="Employer Mgmt" CssClass="blue" runat="server" Expanded="true" >
                          <Items>
                              ...
                              <telerik:RadPanelItem Text="Add Employer" NavigateUrl="/Broker/AddEmployer.aspx" runat="server"></telerik:RadPanelItem>
                          </Items>
                      </telerik:RadPanelItem>
                      ...
                      <telerik:RadPanelItem Text="Accounting" runat="server" CssClass="blue" Expanded="true" >
                          <Items>
                              ...
                              <telerik:RadPanelItem Text="Broker" runat="server" NavigateUrl="/Broker/Accounting.aspx"></telerik:RadPanelItem>
                          </Items>
                      </telerik:RadPanelItem>
                      <telerik:RadPanelItem runat="server" CssClass="blue" Text="Quote Mgmt" Expanded="true" >
                          <Items>
                              <telerik:RadPanelItem runat="server" NavigateUrl="/Broker/ViewQuotes.aspx" Text="View Quotes"></telerik:RadPanelItem>

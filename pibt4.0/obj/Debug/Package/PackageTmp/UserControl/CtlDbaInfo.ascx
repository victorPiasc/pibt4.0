                    ...
                    <FormTemplate>
                        ...
                        <table class="table-container">
                            <tr class="row">
                                ...
                                <td class="item-value">
                                    <asp:TextBox ID="tbDBANAME" Text='<%# Bind( "DBANAME" ) %>' runat="server" MaxLength="30" Width="250"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfvCarrierId" runat="server" ControlToValidate="tbDBANAME" CssClass="required-info"

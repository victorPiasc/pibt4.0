        ...
        <table class="table-container">
            <tbody>
                ...
                <tr class="row">
                    ...
                    <td class="item-value">
                        <asp:TextBox ID="tb_newLoginName" runat="server" CssClass="form-control" Height="26px" MaxLength="10" ValidationGroup="username" ></asp:TextBox>
                    </td>
                    <td>
                        <asp:RequiredFieldValidator ID="tb_newLoginReq" runat="server" CssClass="required-info" ControlToValidate="tb_newLoginName" ErrorMessage="* New user name required to update User name." ValidationGroup="username"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td colspan="3"></td>
                ...
                <tr class="row">
                    <td></td>
                    <td class="item-value">
                        <asp:Button ID="bt_changeLoginName" CssClass="btn" runat="server" Text="Change Username" OnClick="bt_changeLoginName_Click" ValidationGroup="username" />
                    </td>
                </tr>
                <tr>
                    <td colspan="3">&nbsp;</td>
                ...
                <tr class="row">
                    ...
                    <td class="item-value">
                        <asp:TextBox ID="txtOldPassword" runat="server" CssClass="form-control" Height="28px" MaxLength="50" TextMode="Password" ValidationGroup="ChangePassword"></asp:TextBox>
                    </td>
                    <td>
                ...
                <tr class="row">
                    ...
                    <td class="item-value">
                        <asp:TextBox ID="txtNewPassword" runat="server" CssClass="form-control" Height="28px" MaxLength="50" TextMode="Password" ValidationGroup="ChangePassword"></asp:TextBox>
                    </td>
                    <td>
                ...
                <tr class="row">
                    ...
                    <td class="item-value">
                        <asp:TextBox ID="txtConfirmPassword" runat="server" CssClass="form-control" Height="28px" TextMode="Password" ValidationGroup="ChangePassword"></asp:TextBox>
                    </td>
                    <td>

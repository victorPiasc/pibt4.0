...
<div class="row">
    ...
    <div class="column-3 col-md-3">
        <span class="simpleText bold">State:</span>
            ...
            <div style="display:block">
                <asp:RequiredFieldValidator ID="pStateReq" runat="server" CssClass="required-info" ErrorMessage="*State is required" ControlToValidate="pState" Display="Dynamic"></asp:RequiredFieldValidator>
    ...
    <div class="column-3 col-md-3">
        ...
        <asp:TextBox ID="pZip" runat="server" CssClass="form-control" style="display:inline; width:86%" MaxLength="9"></asp:TextBox>
            <div style="display:block">
                ...
                <asp:RegularExpressionValidator ID="pZipReg" runat="server" CssClass="required-info" ErrorMessage="*5-9 Numbers only" ControlToValidate="pZip" ValidationExpression="^[0-9]{5,9}$" Display="Dynamic"></asp:RegularExpressionValidator>
            </div>
    </div>
</div>
<div class="row">
    <div class="column-6 col-md-6">
        ...
        <div style="display:block">
            <asp:RegularExpressionValidator ID="phoneReq" runat="server" CssClass="required-info" ErrorMessage="*10 Numbers only" ControlToValidate="phone" ValidationExpression="^[0-9]{10}$"></asp:RegularExpressionValidator>
        </div>
    </div>
    <div class="column-6 col-md-6">
        ...
        <div style="display:block">
            <asp:RegularExpressionValidator ID="faxReq" runat="server" CssClass="required-info" ErrorMessage="*10 Numbers only" ControlToValidate="fax" ValidationExpression="^[0-9]{10}$"></asp:RegularExpressionValidator>
        </div>
    </div>
</div>
<div class="row">
    ...
    <div class="row">
        ...
        <div class="column-3 col-md-3">
            ...
            <div style="display:block">
                ...
                <asp:RegularExpressionValidator ID="mZipReg" runat="server" CssClass="required-info" ErrorMessage="*5-9 Numbers only" ControlToValidate="mZip" ValidationExpression="^[0-9]{5,9}$"></asp:RegularExpressionValidator>
            </div>
        </div>
    </div>
</asp:Panel>
...
<div class="row">
    <div class="column-4 col-md-4">
        ...
        <div style="display:block">
            <asp:RequiredFieldValidator ID="taxIdReq" runat="server" CssClass="required-info" ErrorMessage="*Required" ControlToValidate="taxId"></asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator ID="taxIdReg" runat="server" CssClass="required-info" ErrorMessage="*9 Numbers only" ControlToValidate="taxId" ValidationExpression="^[0-9]{9}$"></asp:RegularExpressionValidator>
        </div>
    </div>
    <div class="column-4 col-md-4">
     ...
     <div class="column-4 col-md-4">
        ...
        <asp:TextBox ID="sic" runat="server" CssClass="form-control" style="display:inline; width:90%;" MaxLength="10"></asp:TextBox>
        <div style="display:block">
            ...
            <asp:RegularExpressionValidator ID="sicReg" runat="server" CssClass="required-info" ErrorMessage="*4-10 Numbers only" ControlToValidate="sic" ValidationExpression="^[0-9]{4,10}$"></asp:RegularExpressionValidator>
        </div>
    </div>
</div>
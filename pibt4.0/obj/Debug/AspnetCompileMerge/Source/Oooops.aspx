            ...
            <div class="section-body">
                <ul class="login-page" style="width: auto;">
                    <li>You are logged out. Please click
                        <asp:LoginStatus ID="LoginStatus1" LoginText="here to login" CssClass="link" LogoutText="here to login"
                    ...
                    <li>Your current <span style="color: red; font-weight: bold;">session</span> time may
                        be out. Please click
                        <asp:LoginStatus ID="LoginStatus2" LoginText="here to login" CssClass="link" LogoutText="here to login"
                            runat="server" LogoutAction="Redirect" LogoutPageUrl="~/Login.aspx" />
                        again.</li>

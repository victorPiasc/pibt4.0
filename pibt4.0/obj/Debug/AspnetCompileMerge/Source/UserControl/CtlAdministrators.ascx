    ...
    <fieldset>
       ...
       <table class="table-container">
          <tr class="row">
             ...
             <td class="item-name">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Web Username
             </td>
             <td class="item-value">
...
<telerik:RadGrid ID="AdministratorsGrid" runat="server" AllowPaging="True" Width="100%"
   ...
   <MasterTableView AutoGenerateColumns="False" EditMode="InPlace" DataKeyNames="Id,UserId,Loginname"
      ...
      <Columns>
         <telerik:GridBoundColumn DataField="UserId" SortExpression="UserId" UniqueName="UserId" HeaderText="User ID">
         ...
         <telerik:GridHyperLinkColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Font-Bold="false" HeaderStyle-Wrap="false" DataNavigateUrlFields="UserId"
             DataNavigateUrlFormatString="/Admin/AdminEdit.aspx?uid={0}" Text="Edit">

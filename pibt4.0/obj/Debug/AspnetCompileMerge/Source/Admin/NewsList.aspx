...
<asp:Content ID="Content6" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
   ...
   <telerik:RadGrid ID="RadGridNews" runat="server" AllowPaging="True" Height="100%"
      ...
      OnItemInserted="RadGridNews_ItemInserted" OnItemUpdated="RadGridNews_ItemUpdated" OnUpdateCommand="RadGridNews_UpdateCommand">
      ...
      <MasterTableView AutoGenerateColumns="False" DataKeyNames="NEWSID" AllowSorting="true"
         ...
         <Columns>
            ...
            <telerik:GridBoundColumn DataField="NEWSID" SortExpression="NEWSID" UniqueName="NEWSID" HeaderText="ID">
            ...
            <telerik:GridHyperLinkColumn ItemStyle-HorizontalAlign="Left" UniqueName="" HeaderStyle-Font-Bold="false" HeaderStyle-Wrap="false"
                DataNavigateUrlFields="NewsId" DataNavigateUrlFormatString="/NewsDetails.aspx?id={0}" Text="View">

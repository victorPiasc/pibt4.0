                                ...
                                <tr class="row">
                                    <td class="item-value">
                                        <asp:DropDownList ID="dnl" runat="server" CssClass="form-control">
                                            ...
                                            <asp:ListItem Text="Oct 1st  -10:30am- Crown Plaza Hotel 1221 Chess Drive, Foster City, CA" Value="1" Enabled="false"></asp:ListItem>
                                            <asp:ListItem Text="Oct 6th  -9:00 am- Hilton  100 W. Glenoaks Blvd., Glendale, CA 91202" Value="2" Enabled="false"></asp:ListItem>
                                            <asp:ListItem Text="Oct 8th  -9:00 am- Embassy Suites Brea 900 East Birch Street, Brea, CA 92821" Value="3" Enabled="false"></asp:ListItem>
                                            <asp:ListItem Text="Oct 9th  -9:00 am- Mission Valley Marriot 8757 Rio San Diego., San Diego, CA 92108  " Value="4" Enabled="false"></asp:ListItem>
                                            <asp:ListItem Text="Oct 14th -10:00am- PIAG 5020 Highlands Parkway Smyrna, GA 30082" Value="5" Enabled="false"></asp:ListItem>
                                            <asp:ListItem Text="Oct 21st -9:00 am- PIASC Conference Room 5800 S Eastern Ave. Suite 400, Commerce, CA 90040 " Value="6" Enabled="false"></asp:ListItem>
                                            <asp:ListItem Text="Oct 21st -1:00 pm- PIASC Conference Room 5800 S Eastern Ave. Suite 400, Commerce, CA 90040" Value="7" Enabled="false"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr class="row">

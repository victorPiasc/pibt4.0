                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="left" style="padding-right: 5px; padding-top: 10px;">
                                                                    <ul>
                                                                        <li>You are logged out. Please click
                                                                            <asp:HyperLink ID="HyperLink2" CssClass="red" runat="server" NavigateUrl="/login.aspx">
                                                                                here to login</asp:HyperLink>
                                                                            again.
                                                                        </li>
                                                                        <li>Your current <span style="color: red; font-weight: bold;">session</span> time may be
                                                                            out. Please click
                                                                            <asp:HyperLink ID="HyperLink1" CssClass="red" runat="server" NavigateUrl="/login.aspx">
                                                                                here to login</asp:HyperLink>
                                                                            again.
                                                                        </li>
                                                                        <li>Or check the web address you entered to make sure it's correct.</li>
                                                                        ...
                                                                        <li>Report this technical issue to
                                                                    ...
                                                                    <br />
                                                                    <span style="font-weight: bold; font-size: 12px; color: red; text-indent: 20px; font-style: italic;">Sorry for any inconvenience this may have caused you, please contact your relationshop keeper for any questions.</span>
                                                                </td>
                                                            </tr>
                                                            <tr>

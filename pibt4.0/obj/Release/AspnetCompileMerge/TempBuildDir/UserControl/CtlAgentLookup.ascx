...
<div class="customer-info-box">
    <div class="section-body">
        ...
        <fieldset>
            ...
            <div>
                <telerik:RadGrid ID="CurrentEmployeesByEnrollerGrid" runat="server" DataKeyNames="enrollerId" Skin="MetroTouch" AutoGenerateColumns="false"
                    AllowSorting="true" AllowPaging="true" CssClass="AutoWidthGrid" DataSourceID="odsEmployeeList" PagerStyle-PageButtonCount="15">

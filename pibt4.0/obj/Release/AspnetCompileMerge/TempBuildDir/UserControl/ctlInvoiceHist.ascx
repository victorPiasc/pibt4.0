...
<telerik:RadGrid ID="InvoiceHistGrid" DataKeyNames="invoiceNbr" runat="server" AutoGenerateColumns="False"
    ...
    <MasterTableView DataKeyNames="INVOICENBR" AllowMultiColumnSorting="True">
        ...
        <Columns>
            <telerik:GridBoundColumn DataFormatString="{0:MM/dd/yyyy}" SortExpression="INVOICEDATE" HeaderText="Invoice Date" DataField="INVOICEDATE" UniqueName="INVOICEDATE" DataType="System.DateTime">
            </telerik:GridBoundColumn>
            <telerik:GridBoundColumn DataFormatString="{0:MM/dd/yyyy}" SortExpression="DUEDATE" HeaderText="Due Date" DataField="DUEDATE" UniqueName="DUEDATE" DataType="System.DateTime">
            </telerik:GridBoundColumn>
            ...
            <telerik:GridBoundColumn DataFormatString="{0:C}" DataField="OTHERCHARGEAMOUNT" DataType="System.Decimal" HeaderText="Other Charge Amount" SortExpression="OTHERCHARGEAMOUNT" UniqueName="OTHERCHARGEAMOUNT" ItemStyle-HorizontalAlign="Right">
            </telerik:GridBoundColumn>
            <telerik:GridBoundColumn DataFormatString="{0:C}" DataField="TOTALINVOICEAMOUNT" DataType="System.Decimal" HeaderText="Total Invoice Amount" SortExpression="TOTALINVOICEAMOUNT" UniqueName="TOTALINVOICEAMOUNT" ItemStyle-HorizontalAlign="Right">
            </telerik:GridBoundColumn>
            <telerik:GridBoundColumn DataFormatString="{0:C}" SortExpression="TOTALAMOUNTDUE" HeaderText="Total Amount Due" DataField="TOTALAMOUNTDUE" UniqueName="TOTALAMOUNTDUE" DataType="System.Decimal" ItemStyle-HorizontalAlign="Right">
            </telerik:GridBoundColumn>
        </Columns>
        <EditFormSettings>
    ...
    <telerik:RadPageView runat="server" ID="PageView1">
        <telerik:RadGrid runat="server" ID="InvoiceHistDetailGrid" DataKeyNames="EMPLOYEEID" Skin="MetroTouch"
            ...
            <MasterTableView ShowHeader="true" AutoGenerateColumns="False" DataKeyNames="EMPLOYEEID"
                ...
                <Columns>
                    <telerik:GridBoundColumn DataField="INVOICENBR" DataType="System.Decimal" HeaderText="Invoice #" SortExpression="INVOICENBR" UniqueName="INVOICENBR">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="EMPLOYEEID" DataType="System.Decimal" HeaderText="Employee ID" SortExpression="EMPLOYEEID" UniqueName="EMPLOYEEID">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn DataFormatString="{0:C}" DataField="AMOUNTTOTAL" DataType="System.Decimal" HeaderText="Amount Total" SortExpression="AMOUNTTOTAL" UniqueName="AMOUNTTOTAL" ItemStyle-HorizontalAlign="Right" >
                    </telerik:GridBoundColumn>
                </Columns>
                <DetailTables>
                    <telerik:GridTableView AutoGenerateColumns="false" DataKeyNames="Employeeid" DataSourceID="odsInvoiceHistDetails"
                        ...
                        <Columns>
                            <telerik:GridBoundColumn DataField="COVERAGETYPE" HeaderText="Benefit Type" SortExpression="COVERAGETYPE" UniqueName="COVERAGETYPE">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridNumericColumn Aggregate="Sum" DataField="AMOUNTDUE" DataFormatString="{0:C}" FooterAggregateFormatString="TOTAL AMOUNT: {0:C}" HeaderText="Amount Due" SortExpression="AMOUNTDUE" UniqueName="AMOUNTDUE" ItemStyle-HorizontalAlign="Right">

...
<asp:Content ID="Content6" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <telerik:RadGrid ID="RadGridQA" runat="server" AllowPaging="True" Height="100%" AutoGenerateColumns="False" Skin="MetroTouch" GridLines="None"
        AllowSorting="True" CellSpacing="0" AllowAutomaticInserts="True" CssClass="" AllowAutomaticDeletes="True" AllowAutomaticUpdates="True"
        OnItemCommand="RadGridQA_ItemCommand" DataSourceID="odsQA" OnItemDeleted="RadGridQA_ItemDeleted" OnItemInserted="RadGridQA_ItemInserted"
        OnItemUpdated="RadGridQA_ItemUpdated" oninsertcommand="RadGridQA_InsertCommand" onupdatecommand="RadGridQA_UpdateCommand">
                    ...
                    <table class="table-container">
                        <tr class="row">
                            ...
                            <td class="item-value">
                                ...
                                <asp:RequiredFieldValidator ID="rfvQuestion" runat="server" ControlToValidate="tbQuestion" CssClass="required-info"
                                    ErrorMessage="The question is required" Display="Dynamic" ValidationGroup="CustomerInfo"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr class="row">
                            <td class="item-name">
                        ...
                        <tr class="row">
                            ...
                            <td class="item-value">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="tbKeyWords" CssClass="required-info"
                                    ErrorMessage="The keywords field is required" Display="Dynamic" ValidationGroup="CustomerInfo"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr class="row">
                            <td class="item-name">
                            ...
                            <telerik:RadEditor ID="ContentEditor" Height="500" Skin="Telerik" Content='<%# Bind( "ANSWER" ) %>'
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ContentEditor" CssClass="required-info"
                                    ErrorMessage="An answer is required" Display="Dynamic" ValidationGroup="CustomerInfo"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>

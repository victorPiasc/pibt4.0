...
<asp:Content ID="Content6" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <telerik:RadGrid ID="RadGridEvents" runat="server" AllowPaging="True" Height="100%" Skin="MetroTouch" AutoGenerateColumns="False" GridLines="None"
        AllowSorting="True" CellSpacing="0" AllowAutomaticInserts="True" AllowAutomaticDeletes="True" AllowAutomaticUpdates="True"
        OnItemCommand="RadGridEvents_ItemCommand" DataSourceID="odsEvents" OnInsertCommand="RadGridEvents_InsertCommand" OnItemDeleted="RadGridEvents_ItemDeleted"
        OnItemInserted="RadGridEvents_ItemInserted" OnItemUpdated="RadGridEvents_ItemUpdated" OnUpdateCommand="RadGridEvents_UpdateCommand">
                    ...
                    <table class="table-container">
                        <tr class="row">
                            ...
                            <td class="item-value">
                                ...
                                <asp:RequiredFieldValidator ID="rfvTitle" runat="server" ControlToValidate="tbTitle" CssClass="required-info"
                                    ErrorMessage="Event name is required" Display="Dynamic" ValidationGroup="CustomerInfo"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr class="row">
                            ...
                            <td class="item-value">
                                ...
                                <asp:RangeValidator ID="RangeValidator" runat="server" ControlToValidate="tbCost" CssClass="red"
                                    ErrorMessage="Cost must be 0.00-99999999.00." Display="Dynamic" MaximumValue="99999999.00"
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="tbCost" CssClass="required-info"
                                    ErrorMessage="Cost is required" Display="Dynamic" ValidationGroup="CustomerInfo"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr class="row">
                            ...
                            <td class="item-value">
                                <asp:TextBox ID="tbLocation" Text='<%# Bind( "LOCATION" ) %>' runat="server" MaxLength="200"
                                    Width="300"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="tbLocation" CssClass="required-info"
                                    ErrorMessage="Location is required" Display="Dynamic" ValidationGroup="CustomerInfo"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr class="row">
                            ...
                            <td class="item-value">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="dtPicker" CssClass="required-info"
                                    ErrorMessage="Event Date is required" Display="Dynamic" ValidationGroup="CustomerInfo"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr class="row">
                            <td class="item-name">Key Words:
                        ...
                        <tr class="row">
                            ...
                            <td class="item-value">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ContentEditor" CssClass="required-info"
                                    ErrorMessage="The event content is required" Display="Dynamic" ValidationGroup="CustomerInfo"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>

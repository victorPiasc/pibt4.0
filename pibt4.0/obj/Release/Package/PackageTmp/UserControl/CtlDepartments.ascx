...
<div class="customer-info-box">
    ...
    <div class="section-body">
        ...
        <telerik:RadGrid ID="RadGridDeparts" runat="server" AllowPaging="True" Skin="MetroTouch"
            AutoGenerateColumns="False" GridLines="None" AllowSorting="True" CellSpacing="0" OnNeedDataSource="RadGridDeparts_NeedDataSource"
            OnItemCommand="RadGridDeparts_ItemCommand" AllowAutomaticInserts="true" AllowAutomaticUpdates="false">

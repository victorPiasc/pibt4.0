...
<div class="row">
    <div class="col-md-12">
        <fieldset>
            <telerik:RadGrid ID="commHist" runat="server" Skin="MetroTrouch" AutoGenerateColumns="false" EnableLinqExpressions="false" OnNeedDataSource="commHist_NeedDataSource" AllowMultiRowSelection="false">
                <ClientSettings>

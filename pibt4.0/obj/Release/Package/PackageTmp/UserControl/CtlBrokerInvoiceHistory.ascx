...
<div class="row">
    <div class="col-md-12">
        <fieldset>
            <telerik:RadGrid ID="invoiceHist" runat="server" Skin="MetroTrouch" AutoGenerateColumns="false" EnableLinqExpressions="false" OnNeedDataSource="invoiceHist_NeedDataSource" AllowMultiRowSelection="false">
                <ClientSettings>

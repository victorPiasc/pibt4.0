    ...
    <div class="customer-info-box">
        <div class="section-body">
            ...
            <div>
                 <div class="row">
                    <div class="col-md-12">
                        <asp:DropDownList ID="ddPlanType" AutoPostBack="true" CssClass="form-control" Width="170px" OnSelectedIndexChanged="PlanTypeGrid_SelectedIndexChanged" runat="server"></asp:DropDownList>
                    </div>
                </div>
            </div>
            <div class="section-title">

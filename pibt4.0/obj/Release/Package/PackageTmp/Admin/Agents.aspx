...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <telerik:RadGrid ID="RadGridAgents" runat="server" AllowPaging="True" AllowSorting="true" OnItemDataBound="binder" Height="100%" AutoGenerateColumns="False"
        GridLines="None" OnNeedDataSource="RadGridAgents_NeedDataSource" Skin="MetroTouch">
        ...
        <MasterTableView AutoGenerateColumns="False" EditMode="InPlace" DataKeyNames="Id,UserId,Loginname"
            ...
            <Columns>
                <telerik:GridHyperLinkColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Font-Bold="false" HeaderStyle-Wrap="false" DataNavigateUrlFields="UserId" DataNavigateUrlFormatString="/Admin/AgentDetails.aspx?uid={0}" HeaderText="View Agent ID" DataTextField="UserId" DataTextFormatString="{0}">

...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <telerik:RadGrid ID="LogGrid" runat="server" AllowPaging="True" Height="100%" Skin="MetroTouch" AutoGenerateColumns="False" GridLines="None"
        AllowSorting="true" CellSpacing="0" onneeddatasource="LogGrid_NeedDataSource">

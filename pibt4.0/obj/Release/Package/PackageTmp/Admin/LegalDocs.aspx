...
<asp:Content ID="Content5" ContentPlaceHolderID="FrameHeaderPlaceHolder" runat="server">
    ...
    <a href="/">Home</a> > Legal Document Management
</asp:Content>
<asp:Content ID="Content6" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <telerik:RadGrid ID="RadGridLegalDocs" runat="server" AllowPaging="True" Height="100%" OnItemDataBound="binder" AutoGenerateColumns="False" GridLines="None"
        AllowSorting="True" CellSpacing="0" AllowAutomaticInserts="True" AllowAutomaticDeletes="True" AllowAutomaticUpdates="True" Skin="MetroTouch"
        OnItemCommand="RadGridLegalDocs_ItemCommand" DataSourceID="odsLegalDocs" OnInsertCommand="RadGridLegalDocs_InsertCommand"
        OnItemInserted="RadGridLegalDocs_ItemInserted" OnItemUpdated="RadGridLegalDocs_ItemUpdated" OnUpdateCommand="RadGridLegalDocs_UpdateCommand">
        <PagerStyle Mode="NextPrevAndNumeric" />
        <GroupingSettings CaseSensitive="false" />
        <MasterTableView AutoGenerateColumns="False" DataKeyNames="ID" AllowSorting="true"
            Height="100%" PageSize="16" CommandItemDisplay="Top" CommandItemSettings-ShowRefreshButton="false"
                        ...
                        <tr class="row">
                            ...
                            <td class="item-value">
                                ...
                                <asp:RequiredFieldValidator ID="rfvDescription" runat="server" ControlToValidate="tbDescription" CssClass="required-info"
                                    ErrorMessage="Description is required" Display="Dynamic" ValidationGroup="CustomerInfo"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr class="row">
                            <td class="item-name">
                            ...
                            <td class="item-value">
                                ...
                                <asp:RequiredFieldValidator ID="rfvCarrierId" runat="server" ControlToValidate="tbCarrierId" CssClass="required-info"
                                    ErrorMessage="Carrier ID is required" Display="Dynamic" ValidationGroup="CustomerInfo"></asp:RequiredFieldValidator>
                                <asp:RangeValidator ID="rfCarrierId" runat="server" ControlToValidate="tbCarrierId" MinimumValue="0" MaximumValue="999"
                                    CssClass="required-info" ErrorMessage="Carrier ID must be 0-999" ValidationGroup="CustomerInfo"></asp:RangeValidator>
                            </td>
                        </tr>
                        <tr class="row">
                            <td class="item-name">
                            ...
                            <td class="item-value">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ContentEditor" CssClass="required-info"
                                    ErrorMessage="The legal contert is required" Display="Dynamic" ValidationGroup="CustomerInfo"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
